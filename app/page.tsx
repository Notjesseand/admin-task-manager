...
//                 <li className=" ">it_admin</li>
//                 <li className=" ">tech_admin</li>
//                 <li className=" ">academic_admin</li>
//                 <li className=" ">finance_admin</li>
//               </ul>
//             </div>
//             {/* Password Section */}
//             <div>
...
//                 Password
//               </h2>
//               <p className="  text-gray-300 bg-gray-900 px-4 py-2 rounded-lg inline-block">
//                 admin123
//               </p>
//             </div>
//           </div>
